...
<div className='grid grid-cols-2 gap-5'>
    { /* Mapeamos un arreglo de respuestas correctas y respuestas incorrectas*/}
    {
...
hover:bg-yellow600 hover:text-black font-medium" 
onClick={() => {
    setAnswered(false);
...
>
    ...
    <button className="border-2 border-yellow-600 text-yellow-600 rounded-md px-5 py-2 
hover:bg-yellow600 hover:text-black font-medium" onClick={onNextQuestion}>
    Siguiente Pregunta
</button>
)}
</div>   
